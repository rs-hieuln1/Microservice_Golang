...
func (m *Mail) buildHTMLMessage(msg Message) (string, error) {
	// Here would be the logic to build the HTML message using templates
	// For simplicity, let's assume it returns a simple formatted string
...
func (m *Mail) buildPlainTextMessage(msg Message) (string, error) {
	// Here would be the logic to build the plain text message using templates
	// For simplicity, let's assume it returns a simple formatted string
...
func (m *Mail) inlineCSS(html string) (string, error) {
	// Here would be the logic to inline CSS styles into the HTML
	// For simplicity, let's assume it returns the original HTML
